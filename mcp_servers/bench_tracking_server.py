...
if __name__ == "__main__":
    agent = BenchTrackingAgent()

    # Test status update
    import asyncio
    result = asyncio.run(agent.update_consultant_status(
        consultant_id=1, 
        new_status="available",
        activity_description="Back from client project"
    ))
    print("Status Update Result:", result)
